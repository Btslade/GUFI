...
def parse_command_line_arguments():
    ...
    parser.add_argument("-s", "-S", "--summary", dest = "S", help="Summary command", required = True)
    parser.add_argument("-e", "-E", "--entires", dest = "E", default = "None", help="Name of machine")
    parser.add_argument("-t", "-T", "--tree", dest = "tree",  help="What tree you are running on", required= True)
